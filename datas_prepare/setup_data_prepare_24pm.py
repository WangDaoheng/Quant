...
from datas_prepare.C01_data_download_daily.download_insight_data_24pm import SaveInsightData24PM
...
class RunData24PM:
    ...
    def __init__(self):
        self.save_insight_24pm = SaveInsightData24PM()
